...
import com.huishu.oa.core.common.constant.dictmap.DeptDict;
...
import com.huishu.oa.modular.system.wrapper.DeptWrapper;
...
public class DeptController extends BaseController {
     ...
     * 删除部门
     */
    @BusinessLog(value = "删除部门", key = "id", dict = DeptDict.class)
    ...
    public List<ZTreeNode> deptTreeListByRoleId(@PathVariable Integer roleId) {
        List<Long> deptIdsByRoleId = this.deptService.getDeptIdsByRoleId(roleId);
