package com.huishu.oa.config.datasource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "oa.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2, proxyTargetClass = true)
@MapperScan(basePackages = {"com.huishu.oa.modular.*.dao", "com.huishu.oa.multi.dao"})
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "oa.muti-datasource")
    ...
    public DynamicDataSource mutiDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties) {
        ...
        DruidDataSource dataSourceOa = dataSource(druidProperties);
        ...
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[0], dataSourceOa);
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[1], bizDataSource);
        dynamicDataSource.setTargetDataSources(hashMap);
        dynamicDataSource.setDefaultTargetDataSource(dataSourceOa);
