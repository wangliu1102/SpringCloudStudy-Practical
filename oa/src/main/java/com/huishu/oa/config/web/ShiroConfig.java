...
import com.huishu.oa.core.interceptor.OaUserFilter;
import com.huishu.oa.core.shiro.ShiroDbRealm;
...
public class ShiroConfig {
    ...
    public DefaultWebSessionManager defaultWebSessionManager(CacheManager cacheShiroManager, OaProperties oaProperties) {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        myFilters.put("user", new OaUserFilter());
