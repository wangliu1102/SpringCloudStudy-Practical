...
public class TransSFZ {
    ...
    public static void main(String[] args) {
        // 例子 511702800222130      340402990807061
        System.out.println(get18Ic("340402990807061"));
        // 结果 511702198002221308   34040219990807061X
        System.out.println(get18Ic("340825199006193916"));
        String aa = null;
        System.out.println("aa="+aa.toUpperCase());
        String aaa = "";
        System.out.println("aaa="+aaa.toUpperCase());
