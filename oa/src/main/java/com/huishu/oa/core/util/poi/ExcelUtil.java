...
import com.huishu.oa.core.common.annotation.Excels;
import com.huishu.oa.core.common.exception.BizExceptionEnum;
import com.huishu.oa.core.util.*;
...
//    private OaProperties oaProperties;
     ...
     * @return 结果
     */
    public ResponseData importTemplateExcel(String sheetName) {
    ...
    public ResponseData exportExcel() {
        ...
        try {
            ...
            throw new ServiceException(BizExceptionEnum.EXPORT_EXCEL_ERROR);
        } finally {
            if (wb != null) {
                try {
                    wb.close();
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = SpringContextHolder.getBean(OaProperties.class).getFileUploadMapping() + filename;
