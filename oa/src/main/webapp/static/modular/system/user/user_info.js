...
UserInfoDlg.collectData = function () {
    this.set('id').set('account').set('sex').set('avatar')
        .set('email').set('name').set('birthday').set('deptId').set('phone').set('address');
};
...
UserInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(HuiShu.ctxPath + "/mgr/add", function (data) {
        HuiShu.success("添加成功!");
...
UserInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(HuiShu.ctxPath + "/mgr/edit", function (data) {
        HuiShu.success("修改成功!");
 ...
 * 个人中心修改
 */
UserInfoDlg.editUserInfo = function () {
    this.clearData();
    this.collectData();
    if (!this.validate()) {
        return;
    ...
    //提交信息
    var ajax = new $ax(HuiShu.ctxPath + "/mgr/editUserInfo", function (data) {
        HuiShu.success("修改成功!");
    }, function (data) {
        HuiShu.error("修改失败!" + data.responseJSON.message + "!");
    });
...
UserInfoDlg.chPwd = function () {
    var ajax = new $ax(HuiShu.ctxPath + "/mgr/changePwd", function (data) {
        HuiShu.alert("修改成功!");
        function wait(){
...
$(function () {
    HuiShu.initValidator("userInfoForm", UserInfoDlg.validateFields);
