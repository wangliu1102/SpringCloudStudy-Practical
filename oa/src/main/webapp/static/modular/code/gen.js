...
Code.generate = function () {
    ...
    var baseAjax = HuiShu.baseAjax("/code/generate", "生成代码");
...
Code.setTableName = function (tableName) {
    ...
    $("#className").val(HuiShu.underLineToCamel(tableName.substring(preSize)));
};
...
Code.showMenuSelectTree = function () {
    HuiShu.showInputTree("parentMenuName", "pcodeTreeDiv", 15, 34);
};
