var HuiShu = {
    ...
    baseAjax: function (url, tip) {
        var ajax = new $ax(HuiShu.ctxPath + url, function (data) {
            HuiShu.success(tip + "成功!");
        }, function (data) {
            HuiShu.error(tip + "失败!" + data.responseJSON.message + "!");
        });
        return ajax;
    },
    changeAjax: function (url) {
        return HuiShu.baseAjax(url, "修改");
    },
    ...
    newCrontab: function (href, menuName) {
        ...
        if (needCreateCrontab) {
            ...
            var iframeContent = '<iframe class="J_iframe" name="iframe' + HuiShu.randomNum(100,999) + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
